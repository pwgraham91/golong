"""
Django settings for golong project.
...
SECRET_KEY = '(de+-+zdm4ur1)ygq#i^vvbjwgv_m_$ta0%1*z^@r@ej6!))wg'
...
ROOT_URLCONF = 'golong.urls'

WSGI_APPLICATION = 'golong.wsgi.application'
